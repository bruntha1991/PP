 ...
 */
class Invoice extends \a\aBundle\Entity\Invoice implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'paymentDate', 'paymentStatus', 'paymentMethod', 'id');
        }
