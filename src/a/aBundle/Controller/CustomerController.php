...
use a\aBundle\Entity\Customer;
use a\aBundle\Form\CustomerType;
...
class CustomerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('aaBundle:Customer')->findAll();

        return $this->render('aaBundle:Customer:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('aaBundle:Customer:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('aaBundle:Customer')->find($id);
        ...
        return $this->render('aaBundle:Customer:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('aaBundle:Customer:edit.html.twig', array(
            'entity'      => $entity,
