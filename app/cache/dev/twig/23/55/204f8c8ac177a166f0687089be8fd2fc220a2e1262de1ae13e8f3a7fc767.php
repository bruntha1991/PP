...
/* aaBundle:Car:index.html.twig */
class __TwigTemplate_2355204f8c8ac177a166f0687089be8fd2fc220a2e1262de1ae13e8f3a7fc767 extends Twig_Template
{
    ...
    <table class=\"records_list\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo "            <tr>
                <td><a href=\"";
            // line 19
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("car_show", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
            echo "\">";
            ...
            echo "</td>
                <td>";
            // line 21
            if ($this->getAttribute($this->getContext($context, "entity"), "manufactureYear")) {
        ...
        <li>
            <a href=\"";
        // line 40
        echo $this->env->getExtension('routing')->getPath("car_new");
        echo "\">
                Create a new entry
            </a>
        </li>
    ...
    {
        return "aaBundle:Car:index.html.twig";
    }
