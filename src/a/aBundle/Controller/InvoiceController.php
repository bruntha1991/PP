...
use a\aBundle\Entity\Invoice;
use a\aBundle\Form\InvoiceType;
...
class InvoiceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('aaBundle:Invoice')->findAll();

        return $this->render('aaBundle:Invoice:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('aaBundle:Invoice:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('aaBundle:Invoice')->find($id);
        ...
        return $this->render('aaBundle:Invoice:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('aaBundle:Invoice:edit.html.twig', array(
            'entity'      => $entity,
