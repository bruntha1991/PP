...
use a\aBundle\Entity\Vendor;
use a\aBundle\Form\VendorType;
...
class VendorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('aaBundle:Vendor')->findAll();

        return $this->render('aaBundle:Vendor:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('aaBundle:Vendor:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('aaBundle:Vendor')->find($id);
        ...
        return $this->render('aaBundle:Vendor:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('aaBundle:Vendor:edit.html.twig', array(
            'entity'      => $entity,
