...
use a\aBundle\Entity\Car;
use a\aBundle\Form\CarType;
...
class CarController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('aaBundle:Car')->findAll();

        return $this->render('aaBundle:Car:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('aaBundle:Car:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('aaBundle:Car')->find($id);
        ...
        return $this->render('aaBundle:Car:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('aaBundle:Car:edit.html.twig', array(
            'entity'      => $entity,
